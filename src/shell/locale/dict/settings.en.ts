export const settings = {
  ...
  "settings.harnessInstall.description": "Local: your global npm @deepseek-ai/dsh. In-app: downloaded by this app into AppData.",
  ...
  "settings.harnessInstall.mismatch": "Running «{running}» differs from your choice «{preference}»; restart harness",
  ...
  "settings.harnessInstall.restartConfirmBody": "Restart harness for the new source to take effect.",
  "settings.harnessInstall.restartNow": "Restart now",
  "settings.harnessInstall.restartLater": "Restart manually later",
  "settings.harnessInstall.switchedRestart": "Running version differs from selected version — restart harness",
  ...
  "settings.mirror.description": "Affects Node downloads and npm registry; applies on next install or update",
  ...
  "settings.proxy.saved": "Proxy saved, restart harness from About to apply to a running process",
  ...
  "settings.window.description": "Your choice is remembered; use the button below to ask again next time",
  ...
  "settings.port.description": "0 or empty = shell default (dev 3081 / release 3080); auto-increments if busy. Restart harness after change.",
  ...
  "settings.cli.description": "Writes dsh.cmd under AppData/bin and adds it to user PATH (does not edit shell rc). New terminals only.",
