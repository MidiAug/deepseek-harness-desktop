export const boot = {
  ...
  "onboarding.appData.warnAutoAdjusted": "The AppData folder was taken; a fallback path is in use",
  "onboarding.appData.warnOccupied": "All AppData slots were taken; an emergency folder is in use — check Settings → Data",
  ...
  "boot.progress.downloadNode": "Downloading Node.js",
  "boot.progress.downloadNodeHint": "Fetching the full runtime bundle",
  "boot.progress.downloadPct": "About {pct}% done",
  "boot.progress.installDsh": "Installing Harness",
  "boot.progress.installHint": "First install usually takes a few minutes — keep network connected",
  "boot.progress.installHintMedium": "Many dependencies — may take 10+ minutes",
  "boot.progress.installHintLong": "Still fetching and extracting packages — please wait",
  "boot.progress.installHintVeryLong": "Taking longer than usual — expand the log below to check for active downloads",
  "boot.progress.elapsedSec": "{n}s elapsed",
  "boot.progress.elapsedMin": "{m}:{s} elapsed",
  "boot.progress.startUi": "Starting the official UI",
  "boot.progress.startUiHint": "Opens automatically when the service is ready",
  "boot.progress.stageWorking": "Please wait…",
